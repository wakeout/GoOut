g_l = [];
g_l.MONTHS = [ "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio",
		"Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre" ];
g_l.DAYS_3 = [ "Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado" ];
g_l.MONTH_FWD = "Siguiente mes";
g_l.MONTH_BCK = "Pasado mes";
g_l.YEAR_FWD = "Siguiente año";
g_l.YEAR_BCK = "Pasado año";
g_l.CLOSE = "Cerrar calendario";
g_l.ERROR_2 = g_l.ERROR_1 = "Date object invalid!";
g_l.ERROR_4 = g_l.ERROR_3 = "Target invalid";
g_jsDatePickImagePath = "../images/calendario/";
