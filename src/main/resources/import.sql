insert into Usuario (id, login, email, rol, password, borrado, nombre) values(1 ,'marquitos', 'mlaina@ucm.es', 'admin', '$2a$10$tBT2yNGyOp0bqMCN7kaYO.D0uXUJF7EmdrXaTb26vPId7KcQOBUIe', false, 'marcos')
...
insert into Usuario (id, login, email, rol, password, borrado, nombre) values(5 ,'jorge','jorge@ucm.es', 'usuario', '$2a$10$tBT2yNGyOp0bqMCN7kaYO.D0uXUJF7EmdrXaTb26vPId7KcQOBUIe', false, 'jorge')
...
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado) values(2, 'zombies',  4,'Madrid',  4, 'publica', 1, '2',false, 'cerrada')
...
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado) values(4, 'xbox',9,  'Madrid', 20, 'publica', 2, '4',false, 'cerrada')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado) values(5, 'concierto', 12, 'Madrid', 15, 'publica', 4, '5',false, 'abierta')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado) values(6, 'senderismo',  4,'Madrid', 4, 'publica', 4, '6',false, 'cerrada')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado) values(7, 'fiesta',9,  'Madrid', 20, 'publica', 5, '7',false, 'abierta')
...
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado) values(9, 'viaje a benidorm',9,  'Madrid', 20, 'publica', 1, '9',false, 'abierta')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado) values(10, 'cable esquí en el lago',9,  'Madrid', 20, 'publica', 2 ,'10',false, 'cerrada')
