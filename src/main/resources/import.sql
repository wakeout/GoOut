...
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado, fecha_ini, fecha_fin) values(1, 'cerves', 12, 'Madrid', 15, 'privada', 1, '1',false,'abierta', '2016-05-01', '2016-06-01')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado, fecha_ini, fecha_fin) values(2, 'zombies',  4,'Navacerrada',  4, 'publica', 1, '2',false, 'cerrada', '2011-01-01', '2012-06-01')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado, fecha_ini, fecha_fin) values(3, 'futbol',9,  'Madrid', 20, 'privada', 1, '3',false, 'abierta', '2016-06-01', '2016-07-01')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado, fecha_ini, fecha_fin) values(4, 'xbox',9,  'Torrelodones', 20, 'publica', 4, '4',false, 'cerrada', '2006-01-01',  '2016-06-12')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado, fecha_ini, fecha_fin) values(5, 'concierto', 12, 'Barcelona', 15, 'publica', 4, '5',false, 'abierta', '2016-08-01', '2017-06-01')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado, fecha_ini, fecha_fin) values(6, 'senderismo',  4,'Navacerrada', 4, 'publica', 4, '6',false, 'cerrada', '2009-01-01', '2012-08-01')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado, fecha_ini, fecha_fin) values(7, 'fiesta',9,  'Ibiza', 20, 'publica', 5, '7',false, 'abierta', '2016-10-01', '2016-11-13')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado, fecha_ini, fecha_fin) values(8, 'visitar la ciudad',9,  'Madrid', 20, 'publica', 6 , '8',false, 'cerrada', '2008-01-01', '2009-06-01')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado, fecha_ini, fecha_fin) values(9, 'viaje a benidorm',9,  'Benidorm', 20, 'publica', 1, '9',false, 'abierta', '2016-11-01', '2016-12-01')
insert into Actividad (id, nombre, npersonas, localizacion, max_personas, privacidad, creador,foro, eliminado, estado, fecha_ini, fecha_fin) values(10, 'cable esquí en el lago',9,  'Asturias', 20, 'publica', 2 ,'10',false, 'cerrada', '2012-01-01', '2012-06-01')
...
insert into comentario (id, asunto, sugiero, id_foro, usuario) values (2, 'Vale yo voy...espera...NO!', false,'1', '2')
insert into comentario (id, asunto, sugiero) values (3, 'que preferis que lleve peli o juego?', false)
insert into comentario (id, asunto, sugiero) values (4, 'Pizzas', false)
