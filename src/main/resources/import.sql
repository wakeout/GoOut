...
insert into Actividad (id, nombre, npersonas, localizacion, id_imagen, max_personas, privacidad) values(1, 'cerves', 12, 'Madrid', '1.jpg', 15, 'privada')
...
insert into Actividad (id, nombre, npersonas, localizacion, id_imagen, max_personas, privacidad) values(3, 'futbol',9,  'Madrid', '3.jpg', 20, 'privada')
