...
insert into comentario (id, asunto, sugiero, borrado, id_foro, usuario) values (3, 'que preferis que lleve peli o juego?', false, false, '1', '4')
insert into comentario (id, asunto, sugiero, borrado, id_foro, usuario) values (4, 'Pizzas', false, false, '1', '4')
insert into comentario (id, asunto, sugiero, borrado, id_foro, usuario) values (5, 'oye os parece bien que vayamos a por unas palomitas?', false, false, '1', '4')
insert into comentario (id, asunto, sugiero, borrado, id_foro, usuario) values (6, 'si', false, false, '1', '4')
insert into comentario (id, asunto, sugiero, borrado, id_foro, usuario) values (7, 'no', false, false, '1', '4')
insert into comentario (id, asunto, sugiero, borrado, id_foro, usuario) values (8, 'me da pereza', false, false, '1', '4')
insert into comentario (id, asunto, sugiero, borrado, id_foro, usuario) values (9, 'a las 9?', false, false, '1', '4')
insert into comentario (id, asunto, sugiero, borrado, id_foro, usuario) values (10, 'vale', false, false, '1', '4')
