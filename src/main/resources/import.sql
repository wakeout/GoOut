...
insert into Actividad (id, nombre, npersonas, latitud, longitud, id_imagen, max_personas) values(1, 'cerves', 12, 1234, 1244, '1.jpg', 15)
insert into Actividad (id, nombre, npersonas, latitud, longitud  ,id_imagen, max_personas) values(2, 'zombies',  4,1200, 1214, '2.jpg', 4)
insert into Actividad (id, nombre, npersonas, latitud, longitud, id_imagen, max_personas) values(3, 'futbol',9,  1000, 1000, '3.jpg', 20)
insert into Actividad (id, nombre, npersonas, latitud, longitud, id_imagen, max_personas) values(4, 'xbox',9,  1000, 1000, '33.jpg', 20)
insert into Actividad (id, nombre, npersonas, latitud, longitud, id_imagen, max_personas) values(5, 'concierto', 12, 1234, 1244, '5.jpg', 15)
insert into Actividad (id, nombre, npersonas, latitud, longitud  ,id_imagen, max_personas) values(6, 'senderismo',  4,1200, 1214, '6.jpg', 4)
insert into Actividad (id, nombre, npersonas, latitud, longitud, id_imagen, max_personas) values(7, 'fiesta',9,  1000, 1000, '5.jpg', 20)
insert into Actividad (id, nombre, npersonas, latitud, longitud, id_imagen, max_personas) values(8, 'visitar la ciudad',9,  1000, 1000, '4.jpg', 20)
insert into Actividad (id, nombre, npersonas, latitud, longitud, id_imagen, max_personas) values(9, 'viaje a benidorm',9,  1000, 1000, '7.jpg', 20)
insert into Actividad (id, nombre, npersonas, latitud, longitud, id_imagen, max_personas) values(10, 'cable esquí en el lago',9,  1000, 1000, '8.jpg', 20)
insert into Actividad (id, nombre, npersonas, latitud, longitud, id_imagen, max_personas) values(8, 'paintball',9,  1000, 1000, '9.jpg', 20)
